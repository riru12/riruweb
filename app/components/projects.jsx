                ...
                <div className="grid auto-rows-fr gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    {projects.map(project => (
                        <div key={project.id} className="group cursor-default">
                            <div className="grid grid-cols-1 bg-neutral-900 h-full rounded p-6 sm:group-hover:translate-y-[-10px] transition-transform">
                                <div>
                                    ...
                                    <div id="projectName" className="font-bold text-neutral-300 group-hover:text-[#bcedc5] transition-colors mt-10">{project.name}</div>
                                    <div id="projectDesc" className="text-neutral-400 mt-2 mb-6">{project.description}</div>
                                </div>
                                <div>
                                    <div id="projectTech" className="flex font-mono text-neutral-500 text-xs h-full items-end">{project.technologies.join(' ')}</div>
                                </div>
                            </div>
                        </div>
                    ))}
