...
const Hero = () => {
    return(
        <div id="hero" className="flex flex-col justify-center items-center h-screen px-4 mx-0 md:mx-[20vw]">
            <div className="flex justify-center unfancy font-mono text-neutral-400 py-2">hello! i'm</div>
            ...
            <div className="flex justify-center unfancy font-mono text-neutral-400 py-6">developer, digital artist, and pc enthusiast</div>
        </div>
    )
}
