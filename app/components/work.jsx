                ...
                <div className="flex gap-10 h-fit flex-col md:h-[40vh] md:flex-row">
                    <div className="relative h-min">
                            <nav className="flex flex-row md:flex-col">
                                ...
                                <div className="whitespace-nowrap w-[33.3%] md:w-full"><label htmlFor="tab-2" className="block font-mono text-neutral-300 cursor-pointer py-2 px-0 text-sm text-center md:px-4 md:text-base md:text-left hover:bg-neutral-900">AUB</label></div>
                                <div className="whitespace-nowrap w-[33.3%] md:w-full"><label htmlFor="tab-3" className="block font-mono text-neutral-300 cursor-pointer py-2 px-0 text-sm text-center md:px-4 md:text-base md:text-left hover:bg-neutral-900">Freelance</label></div>
                            </nav>
