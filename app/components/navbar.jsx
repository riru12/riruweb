...
const Navbar = () => {
    return (
        <div className="flex fixed w-full justify-center mx-0 px-4 bottom-5 md:justify-normal md:mx-[20vw] md:top-5 md:bottom-auto">
            <nav className="flex grow justify-around rounded-2xl bg-[#262626b3] backdrop-blur-md border-solid border-stone-700 border-[1px] p-1 gap-1 md:grow-0">
